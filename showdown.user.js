...
"Game messages will be shown to only players.":"游戏信息将只显示给玩家。",
    ...
    "On switch-in, this Pokemon Transforms into the opposing Pokemon that is facing it.":"登场时以对应对方为目标进入变身状态",
    ...
    "Lowers Speed of all Pokémon except itself when hit by an attack.":"被攻击命中时，降低除自己以外的所有宝可梦的速度",
    "Prevents Explosion/Mind Blown/Self-Destruct/Aftermath while this Pokemon is active.":"该特性会使自爆、大爆炸和惊爆大头会使用失败，引爆特性不发动",
    "Boosts the Pokémon's Defense stat when the Pokémon enters a battle.":"登场时，防御上升1级",
    "Boosts the Pokémon's Attack stat when the Pokémon enters a battle.":"登场时，攻击上升1级",
    ...
    "Changes between Full Belly and Hangry Mode at the end of each turn.":"每回合结束时会在饥饿模式和饱腹模式之间切换",
    "Pokémon's head functions as substitute for a physical attack. Restored in hail.":"头部的冰会代替自己承受物理攻击，样子也会改变，下冰雹时恢复原状",
    "The Pokémon is protected by ice scales, which halve the damage taken from special moves.":"特殊攻击造成的伤害减半",
    ...
    "Nullifies abilities while on the field.":"该特性无效化所有其他宝可梦的特性",
    ...
    "Just being next to the Pokémon powers up moves.":"旁边有宝可梦时，招式威力会提升",
    "Ignores the effects of opposing Pokémon's Abilities and moves that draw in moves.":"不受对方宝可梦的能够吸引招式的特性和招式的影响",
    ...
    "Removes Screens and Veil Effects on switchin.":"替换上场时清除反射壁、光墙和极光幕",
