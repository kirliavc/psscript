...
var translations={
    ...
    "Holder's Rock-type attacks have 1.2x power.":"岩石属性招式威力提升20%",
    ...
    "Raises the user's Defense by 2.":"提升使用者的防御两级。",
    ...
    "No additional effect. Hits adjacent Pokemon.":"攻击目标造成伤害。攻击所有临近的宝可梦。",
    ...
    "10% chance to lower the target's Speed by 1.":"有10%的几率使目标的速度下降一级。",
     ...
     "10% chance to lower the target's Speed by 1.":"有10%的几率使目标速度下降一级。",
     ...
     "Lowers the user's Defense and Sp. Def by 1.":"使使用者的防御和特防各下降一级。",
     "30% chance to paralyze the target.":"有30%的几率使对手陷入麻痹状态。",
     "Raises the user's Attack and Speed by 1.":"提升使用者的攻击和速度各一级。",
     "Always does 40 HP of damage.":"必定会造成40点伤害。",
     "20% chance to flinch the target.":"有20%的几率使对手畏缩。",
     ...
     "100% chance to confuse the target.":"100%使目标陷入混乱状态。",
     "10% chance to lower the target's Sp. Def by 1.":"有10%的几率使对手的特防下降一级。",
     ...
     "10% chance to lower the target's Sp. Def by 1.":"有10%的几率使使用者的特防下降一级。",
     ...
     "10% chance to burn the target.":"有10%的几率使对手陷入烧伤状态。",
     ...
     "10% chance to lower the target's Sp. Def by 1.":"10%使目标的特防下降一级。",
     ...
     "Hits two turns after being used.":"在使用技能2回合后攻击。",
     ...
     "Heals the target by 50% of its max HP.":"使目标回复最大HP的50%。",
     ...
     "Always leaves the target with at least 1 HP.":"目标至少会留下1点HP。",
     ...
     "No additional effect. Hits adjacent foes.":"攻击对手造成伤害。攻击邻近的对手。",
     ...
     "More power the heavier the target.":"使用者比目标越重，技能威力越大。",
     ...
     "The target cannot switch out.":"目标将无法下场。",
     ...
     "Heals the user by 50% of its max HP.":"恢复使用者最大HP的50%。",
     "The last move the target used replaces this one.":"这个技能将会变成目标会后使出的技能。",
     "User's next move will not miss the target.":"使用者的下一次攻击将不会被回避。",
     ...
     "Lowers the target's Attack by 1.":"使目标的攻击下降一级。",
     "10% chance to lower the target's Attack by 1.":"10%使目标的攻击下降一级。",
     "User steals and eats the target's Berry.":"使用者窃取并食用目标的树果。",
    ...
    "Power doubles if the user's last move failed.":"一定会造成会心一击。",
    ...
    "If the user has no item, it steals the target's.":"如果使用者没有道具，就会偷窃目标的道具。",
    ...
    "Poisons grounded foes on switch-in. Max 2 layers.":"识体换上场的对手中毒，最多累积2次",
    ...
    "Less power as user's HP decreases. Hits foe(s).":"使用者剩余的HP越少，技能威力越低。攻击(所有)对手。",
